...
export function SidebarApp({ children }) {
  ...
  return (
    <TooltipProvider>
      <SidebarProvider>
        <AppSidebar onLoginOpen={() => setLoginOpen(true)} />
        <main className="flex-1 min-w-0 flex flex-col">
          <div className="top-bar w-full sticky top-0 left-0 h-9 flex justify-between items-center border-b border-sidebar-border bg-background">
            ...
            <div className="h-full flex justify-center items-center">
              <Button
                size="xs"
                variant="ghost"
                className="btn-top rounded-none h-full px-5 hover:bg-accent transition-colors"
                onClick={minimize}
              >
              ...
              <Button
                size="xs"
                variant="ghost"
                className="btn-top rounded-none h-full px-5 hover:bg-[#E81123] dark:hover:bg-[#E81123] hover:text-white transition-colors"
                onClick={close}
              >
          ...
          <div className="h-[calc(100vh-2.25rem)] overflow-y-hidden w-full min-w-0">
            <div className="h-full overflow-y-auto max-w-[1400px] w-full">{children}</div>
          </div>
        </main>
      </SidebarProvider>

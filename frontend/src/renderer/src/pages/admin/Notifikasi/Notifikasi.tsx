    ...
    <div className="flex flex-col gap-6 p-3">
      <div>
        ...
        <p className="text-muted-foreground text-sm">
          Informasi mengenai keterlambatan pengembalian buku.
        </p>
      </div>
                ...
                <div className="flex items-center px-4 py-2 gap-4">
                  ...
                  <div className="flex flex-1 items-center justify-between gap-4 min-w-0">
                    <h3 className="font-medium text-sm truncate">
                      {item.anggota.nama} <span className="text-muted-foreground mx-1">•</span>{' '}
                      <span className="text-muted-foreground font-normal">{item.buku.judul}</span>
                    </h3>
                    <div className="flex items-center gap-3 shrink-0">
                      <p className="text-[11px] text-muted-foreground">
                        Tempo:{' '}
                        {format(new Date(item.tanggal_jatuh_tempo), 'dd MMM yyyy', { locale: id })}
                      </p>
                      <Badge
                        variant="destructive"
                        className="text-[9px] h-4 px-1 uppercase font-bold"
                      >
                        Terlambat
                      </Badge>
                    </div>
